    ...
    <div className="relative p-7 md:p-10 flex flex-col gap-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1.5">
          <p className={`text-[9px] tracking-[0.5em] font-black uppercase
      ...
      <div className="flex flex-wrap gap-2">
        {project.tech.map((t) => (
          <span
            key={t}
            className={`text-[10px] tracking-[0.15em] font-bold uppercase px-3 py-1.5 rounded-sm border transition-colors
              ${featured
      ...
      <div className="pt-2 flex items-center gap-3">
        ...
        <span className={`text-[10px] tracking-[0.3em] font-bold uppercase transition-colors
...
const ProjectSection: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-start overflow-y-auto custom-scrollbar">
      <div className="max-w-5xl w-full px-8 md:px-20 pt-24 md:pt-32 pb-16 space-y-24">
        {/* Page Header */}
        <header className="text-center space-y-4 mb-4">
          <motion.h2
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-5xl md:text-6xl font-black glow-text-red tracking-[0.15em] uppercase"
          >
            PROJECT INVENTORY
          </motion.h2>
          <div className="flex items-center justify-center gap-4 text-[10px] tracking-[0.6em] text-white/25 uppercase font-bold">
        ...
        <section className="space-y-8">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-xs tracking-[0.5em] text-accent-red/70 font-black uppercase">
              Featured Missions
            </h3>
        ...
        <section className="space-y-8">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-xs tracking-[0.5em] text-accent-blue/60 font-black uppercase">
              System Modules
            </h3>
